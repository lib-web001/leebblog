import{_ as t,o as l,c as h,ac as n,f as s,a as i}from"./chunks/framework.CrIZQWiq.js";const e="/assets/gridline.D8ajgunZ.png",y=JSON.parse(`{"title":"布局","description":"布局 flex 居中 fit-content width:fit-content 表示将元素宽度收缩为内容宽度 <iframe width='100%' height='auto' frameborder=\\"0\\" srcdoc=' <sty…","frontmatter":{"date":"2021-06-01 16:44:43","tag":["css"],"title":"布局","description":"布局 flex 居中 fit-content width:fit-content 表示将元素宽度收缩为内容宽度 <iframe width='100%' height='auto' frameborder=\\"0\\" srcdoc=' <sty…"},"headers":[],"relativePath":"articles/前端/css.md","filePath":"articles/前端/css.md"}`),p={name:"articles/前端/css.md"};function k(d,a,r,o,g,E){return l(),h("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1622537083000"},a[0]||(a[0]=[n(`<h1 id="布局" tabindex="-1">布局 <a class="header-anchor" href="#布局" aria-label="Permalink to &quot;布局&quot;">​</a></h1><h2 id="flex" tabindex="-1">flex <a class="header-anchor" href="#flex" aria-label="Permalink to &quot;flex&quot;">​</a></h2><p>居中</p><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">.flex</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
