...
<span class="line"><span></span></span>
<span class="line"><span>ssh-keygen</span></span></code></pre></div><p><img src="`+a+`" alt="git" loading="lazy"></p><h4 id="gitignore-文件" tabindex="-1">.gitignore 文件 <a class="header-anchor" href="#gitignore-文件" aria-label="Permalink to &quot;.gitignore 文件&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>*.py // 忽略py文件</span></span>
...
<span class="line"><span>git config core.ignorecase false</span></span></code></pre></div><h3 id="设置-ssh-key" tabindex="-1">设置 ssh key <a class="header-anchor" href="#设置-ssh-key" aria-label="Permalink to &quot;设置 ssh key&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">  ssh-keygen</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -t</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> rsa</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -C</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;3437705679@qq.com&quot;</span></span></code></pre></div><p><img src="`+a+`" alt="git" loading="lazy"></p><h3 id="关闭-git-证书校验" tabindex="-1">关闭 git 证书校验 <a class="header-anchor" href="#关闭-git-证书校验" aria-label="Permalink to &quot;关闭 git 证书校验&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>git config --global http.sslVerify &quot;false&quot;</span></span></code></pre></div><h3 id="开启-git-证书校验" tabindex="-1">开启 git 证书校验 <a class="header-anchor" href="#开启-git-证书校验" aria-label="Permalink to &quot;开启 git 证书校验&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>git config --global http.sslVerify &quot;true&quot;</span></span></code></pre></div><h3 id="github-提速" tabindex="-1">github 提速 <a class="header-anchor" href="#github-提速" aria-label="Permalink to &quot;github 提速&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>目录 windows/system32/devices/etc/hosts</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>151.101.100.133 avatars8.githubusercontent.com</span></span></code></pre></div>`,46)]))}const u=n(t,[["render",l]]);export{k as __pageData,u as default};
