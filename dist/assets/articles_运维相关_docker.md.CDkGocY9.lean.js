import{_ as s,o as n,c as e,ac as p}from"./chunks/framework.CrIZQWiq.js";const b=JSON.parse('{"title":"Docker 安装","description":"Docker 安装 yum 方式安装 Docker 1、更新 yum 源","frontmatter":{"title":"Docker 安装","description":"Docker 安装 yum 方式安装 Docker 1、更新 yum 源"},"headers":[],"relativePath":"articles/运维相关/docker.md","filePath":"articles/运维相关/docker.md","lastUpdated":1780303483000}'),l={name:"articles/运维相关/docker.md"};function i(t,a,c,o,d,r){return n(),e("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1780303483000"},a[0]||(a[0]=[p(`<h1 id="docker-安装" tabindex="-1">Docker 安装 <a class="header-anchor" href="#docker-安装" aria-label="Permalink to &quot;Docker 安装&quot;">​</a></h1><h2 id="yum-方式安装-docker" tabindex="-1">yum 方式安装 Docker <a class="header-anchor" href="#yum-方式安装-docker" aria-label="Permalink to &quot;yum 方式安装 Docker&quot;">​</a></h2><p>1、更新 yum 源</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum update</span></span></code></pre></div><p>2、安装所需环境</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum install -y yum-utils device-mapper-persistent-data lvm2</span></span></code></pre></div><p>3、配置 yum 仓库</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum-config-manager --add-repo https://download.docker.com/linux/centos/docker-ce.repo</span></span></code></pre></div><p>4、安装 Docker（社区版）</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum install docker-ce</span></span></code></pre></div><p>5、启动 Docker 、添加自启动</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>systemctl start docker</span></span>
