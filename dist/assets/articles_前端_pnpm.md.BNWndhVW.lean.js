import{_ as s,o as a,c as p,ac as e}from"./chunks/framework.CrIZQWiq.js";const u=JSON.parse('{"title":"pnpm","description":"pnpm 在开发过程中，前端项目太多每个项目都包含了相同的依赖，太占用内存空间 但是vue2的老项目使用pnpm还是得额外配置 第一步：在项目根目录创建 .npmrc 文件 在你的 Vue2 项目根目录下（和 package.json 同级…","frontmatter":{"title":"pnpm","description":"pnpm 在开发过程中，前端项目太多每个项目都包含了相同的依赖，太占用内存空间 但是vue2的老项目使用pnpm还是得额外配置 第一步：在项目根目录创建 .npmrc 文件 在你的 Vue2 项目根目录下（和 package.json 同级…"},"headers":[],"relativePath":"articles/前端/pnpm.md","filePath":"articles/前端/pnpm.md","lastUpdated":1780303483000}'),l={name:"articles/前端/pnpm.md"};function i(c,n,t,o,r,m){return a(),p("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1780303483000"},n[0]||(n[0]=[e(`<h1 id="pnpm" tabindex="-1">pnpm <a class="header-anchor" href="#pnpm" aria-label="Permalink to &quot;pnpm&quot;">​</a></h1><ul><li><p>在开发过程中，前端项目太多每个项目都包含了相同的依赖，太占用内存空间</p></li><li><p>但是vue2的老项目使用pnpm还是得额外配置</p></li><li><p>第一步：在项目根目录创建 .npmrc 文件 在你的 Vue2 项目根目录下（和 package.json 同级），创建一个名为 .npmrc 的文本文件。</p></li><li><p>第二步：添加关键配置 在 .npmrc 文件中，添加以下内容：</p></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>text</span></span>
