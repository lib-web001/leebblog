import{_ as n,o as s,c as p,ac as e}from"./chunks/framework.CrIZQWiq.js";const h=JSON.parse('{"title":"生命周期","description":"生命周期 应用生命周期","frontmatter":{"tag":["安卓","移动端"],"title":"生命周期","description":"生命周期 应用生命周期"},"headers":[],"relativePath":"articles/前端/uniapp.md","filePath":"articles/前端/uniapp.md","lastUpdated":1734167601000}'),l={name:"articles/前端/uniapp.md"};function i(t,a,c,o,r,d){return s(),p("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1734167601000"},a[0]||(a[0]=[e(`<h1 id="生命周期" tabindex="-1">生命周期 <a class="header-anchor" href="#生命周期" aria-label="Permalink to &quot;生命周期&quot;">​</a></h1><h2 id="应用生命周期" tabindex="-1">应用生命周期 <a class="header-anchor" href="#应用生命周期" aria-label="Permalink to &quot;应用生命周期&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>onLaunch: 当 uni-app 初始化完成时触发(全局只触发一次)</span></span>
