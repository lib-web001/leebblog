import{_ as t,o as l,c as h,ac as n,f as s,a as i}from"./chunks/framework.CrIZQWiq.js";const e="/assets/gridline.D8ajgunZ.png",y=JSON.parse(`{"title":"布局","description":"布局 flex 居中 fit-content width:fit-content 表示将元素宽度收缩为内容宽度 <iframe width='100%' height='auto' frameborder=\\"0\\" srcdoc=' <sty…","frontmatter":{"tag":["css"],"title":"布局","description":"布局 flex 居中 fit-content width:fit-content 表示将元素宽度收缩为内容宽度 <iframe width='100%' height='auto' frameborder=\\"0\\" srcdoc=' <sty…"},"headers":[],"relativePath":"articles/前端/css.md","filePath":"articles/前端/css.md","lastUpdated":1780303483000}`),p={name:"articles/前端/css.md"};function k(d,a,r,o,g,E){return l(),h("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1780303483000"},a[0]||(a[0]=[n(`<h1 id="布局" tabindex="-1">布局 <a class="header-anchor" href="#布局" aria-label="Permalink to &quot;布局&quot;">​</a></h1><h2 id="flex" tabindex="-1">flex <a class="header-anchor" href="#flex" aria-label="Permalink to &quot;flex&quot;">​</a></h2><p>居中</p><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">.flex</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h3 id="容器属性" tabindex="-1">容器属性 <a class="header-anchor" href="#容器属性" aria-label="Permalink to &quot;容器属性&quot;">​</a></h3><p>grid-template-areas:&#39;lt ct rt&#39; &#39;lm cm rm&#39; &#39;lb cb rb&#39; 和 grid-area</p><p>grid: 行、列、以及行列宽高、间距属性的简写</p><p>grid-auto-columns:50px 设置默认列的宽度，好像没啥用？因为我们通常用 grid-template-columns 来定义列的一些配置信息（已经指定了列的宽度，这时候用 grid-auto-columns 是不生效的）</p><p>grid-auto-rows:50px 设置默认行的高度</p><p>grid-auto-flow:[row|column|dense|row dense|column dense] 控制网格元素排列方式</p><p>row: 也是默认值，增加行的方式继续往下排列 (纵向)</p><p>column: 网格元素排列方式是列 (横向)</p><p>dense； 简单理解就是 宽度是 auto 的</p><p>grid-column-gap 列的间距（也可以写作 column-gap ） grid-row-gap 行的间距（也可以写作 row-gap ） gap (grid-gap) 列、行的间距简写（同样，个人不太提倡使用简写方式）</p><h3 id="子容器属性" tabindex="-1">子容器属性 <a class="header-anchor" href="#子容器属性" aria-label="Permalink to &quot;子容器属性&quot;">​</a></h3><p>grid-area: 合并行、列那几个属性的简写 grid-row-start、grid-column-start、grid-row-end、grid-column-end</p><p>grid-column 列合并两个属性的简写（grid-column-start、grid-column-end），中间使用 / 分割开</p><p>grid-column: 1 / 3;</p><p>grid-row 行合并两个属性的简写（grid-row-start、grid-row-end）用法同上</p><p><img src="`+e+`" alt="gridline" loading="lazy"></p><h2 id="媒体查询" tabindex="-1">媒体查询 <a class="header-anchor" href="#媒体查询" aria-label="Permalink to &quot;媒体查询&quot;">​</a></h2><div class="language-css vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">@media</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> screen</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> and</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">min-width</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">300</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">px</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) {</span></span>
...
`},null,-1)]))}const F=t(p,[["render",k]]);export{y as __pageData,F as default};
