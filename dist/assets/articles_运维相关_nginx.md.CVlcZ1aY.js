import{_ as n,o as a,c as p,ac as e}from"./chunks/framework.CrIZQWiq.js";const g=JSON.parse('{"title":"命令","description":"命令","frontmatter":{"date":"2021-06-01 16:44:43","title":"命令","description":"命令"},"headers":[],"relativePath":"articles/运维相关/nginx.md","filePath":"articles/运维相关/nginx.md"}'),l={name:"articles/运维相关/nginx.md"};function i(t,s,c,o,r,d){return a(),p("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1622537083000"},s[0]||(s[0]=[e(`<h2 id="命令" tabindex="-1">命令 <a class="header-anchor" href="#命令" aria-label="Permalink to &quot;命令&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    停止</span></span>
