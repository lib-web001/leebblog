import{_ as s,o as n,c as e,ac as p}from"./chunks/framework.CrIZQWiq.js";const m=JSON.parse('{"title":"solid 5 大设计原则","description":"solid 5 大设计原则 低耦合高内聚 灵活 健壮 稳定 single 单一职责 一个类只做单一功能 open close 开闭原则 扩展开放,修改关闭 继承或者注入 Li 李四替换 年轻人固然有自己的想法，但是祖宗的规矩不能忘记 子类继…","frontmatter":{"tag":["设计模式"],"title":"solid 5 大设计原则","description":"solid 5 大设计原则 低耦合高内聚 灵活 健壮 稳定 single 单一职责 一个类只做单一功能 open close 开闭原则 扩展开放,修改关闭 继承或者注入 Li 李四替换 年轻人固然有自己的想法，但是祖宗的规矩不能忘记 子类继…"},"headers":[],"relativePath":"articles/设计模式/solid.md","filePath":"articles/设计模式/solid.md","lastUpdated":1734167601000}'),l={name:"articles/设计模式/solid.md"};function i(t,a,o,c,d,r){return n(),e("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1734167601000"},a[0]||(a[0]=[p(`<h1 id="solid-5-大设计原则" tabindex="-1">solid 5 大设计原则 <a class="header-anchor" href="#solid-5-大设计原则" aria-label="Permalink to &quot;solid 5 大设计原则&quot;">​</a></h1><p>低耦合高内聚 灵活 健壮 稳定</p><h2 id="single-单一职责" tabindex="-1">single 单一职责 <a class="header-anchor" href="#single-单一职责" aria-label="Permalink to &quot;single 单一职责&quot;">​</a></h2><p>一个类只做单一功能</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interface IAmount{</span></span>
