import{_ as a,o as n,c as p,ac as l}from"./chunks/framework.CrIZQWiq.js";const m=JSON.parse('{"title":"mysql 题目","description":"mysql 题目 MySQL 读写分离及主从时延 如何实现 mysql 的读写分离？ MySQL 主从复制原理的是啥？ 如何解决 mysql 主从同步的延时问题？","frontmatter":{"tag":["八股文"],"title":"mysql 题目","description":"mysql 题目 MySQL 读写分离及主从时延 如何实现 mysql 的读写分离？ MySQL 主从复制原理的是啥？ 如何解决 mysql 主从同步的延时问题？"},"headers":[],"relativePath":"articles/题目/mysql.md","filePath":"articles/题目/mysql.md","lastUpdated":1780303483000}'),e={name:"articles/题目/mysql.md"};function i(t,s,c,o,r,d){return n(),p("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1780303483000"},s[0]||(s[0]=[l(`<h1 id="mysql-题目" tabindex="-1">mysql 题目 <a class="header-anchor" href="#mysql-题目" aria-label="Permalink to &quot;mysql 题目&quot;">​</a></h1><h2 id="mysql-读写分离及主从时延" tabindex="-1">MySQL 读写分离及主从时延 <a class="header-anchor" href="#mysql-读写分离及主从时延" aria-label="Permalink to &quot;MySQL 读写分离及主从时延&quot;">​</a></h2><h3 id="如何实现-mysql-的读写分离" tabindex="-1">如何实现 mysql 的读写分离？ <a class="header-anchor" href="#如何实现-mysql-的读写分离" aria-label="Permalink to &quot;如何实现 mysql 的读写分离？&quot;">​</a></h3><h3 id="mysql-主从复制原理的是啥" tabindex="-1">MySQL 主从复制原理的是啥？ <a class="header-anchor" href="#mysql-主从复制原理的是啥" aria-label="Permalink to &quot;MySQL 主从复制原理的是啥？&quot;">​</a></h3><h3 id="如何解决-mysql-主从同步的延时问题" tabindex="-1">如何解决 mysql 主从同步的延时问题？ <a class="header-anchor" href="#如何解决-mysql-主从同步的延时问题" aria-label="Permalink to &quot;如何解决 mysql 主从同步的延时问题？&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>如何实现 mysql 的读写分离？</span></span>
...
<span class="line"><span>MySQL 主从延迟导致的生产环境的问题</span></span></code></pre></div>`,10)]))}const h=a(e,[["render",i]]);export{m as __pageData,h as default};
