import{_ as a,o as n,c as i,ac as p}from"./chunks/framework.CrIZQWiq.js";const o=JSON.parse('{"title":"优点","description":"优点","frontmatter":{"date":"2021-06-01 16:44:43","tag":["java"],"title":"优点","description":"优点"},"headers":[],"relativePath":"articles/java/mybatis.md","filePath":"articles/java/mybatis.md"}'),e={name:"articles/java/mybatis.md"};function l(t,s,h,d,k,r){return n(),i("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1622537083000"},s[0]||(s[0]=[p(`<h2 id="优点" tabindex="-1">优点 <a class="header-anchor" href="#优点" aria-label="Permalink to &quot;优点&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>● 无侵入：只做增强不做改变，引入它不会对现有工程产生影响，如丝般顺滑</span></span>
