import{_ as s,o as n,c as p,ac as e}from"./chunks/framework.CrIZQWiq.js";const M=JSON.parse('{"title":"Vue 的虚拟 DOM 和 DOM Diff 算法","description":"Vue 的虚拟 DOM 和 DOM Diff 算法 什么是虚拟 DOM？","frontmatter":{"tag":["八股文"],"title":"Vue 的虚拟 DOM 和 DOM Diff 算法","description":"Vue 的虚拟 DOM 和 DOM Diff 算法 什么是虚拟 DOM？"},"headers":[],"relativePath":"articles/题目/虚拟dom.md","filePath":"articles/题目/虚拟dom.md","lastUpdated":1734167601000}'),l={name:"articles/题目/虚拟dom.md"};function i(c,a,t,d,o,D){return n(),p("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1734167601000"},a[0]||(a[0]=[e(`<h1 id="vue-的虚拟-dom-和-dom-diff-算法" tabindex="-1">Vue 的虚拟 DOM 和 DOM Diff 算法 <a class="header-anchor" href="#vue-的虚拟-dom-和-dom-diff-算法" aria-label="Permalink to &quot;Vue 的虚拟 DOM 和 DOM Diff 算法&quot;">​</a></h1><h3 id="什么是虚拟-dom" tabindex="-1">什么是虚拟 DOM？ <a class="header-anchor" href="#什么是虚拟-dom" aria-label="Permalink to &quot;什么是虚拟 DOM？&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>虚拟DOM（Virtual   Dom）是用JS对象来模拟真实DOM中的节点，该对象包含了真实DOM的结构及其属性，用于对比虚拟DOM和真实DOM的差异，减少频繁操作DOM而引起回流重绘所引发的性能问题的！从而进行局部渲染来达到优化性能。</span></span>
...
<span class="line"><span>主要是针对乱序情况</span></span></code></pre></div>`,5)]))}const u=s(l,[["render",i]]);export{M as __pageData,u as default};
